...
# Taken from https://github.com/wagdav/homelab/blob/5cb57a540b5a0ecf0cd48f9f3a771477d255df49/modules/camera-rpi-v1/default.nix
{ config, pkgs, ... }:
...
let
  ...
  libcamera_overlay = (import ./libcam-overlay.nix);
