...
void overviewMenu(UWORD *BlackImage) {
    ...
    Paint_DrawString_EN(0, 40, "Backed up:", &Font16, BACKGROUND_COLOR, WHITE);
    Paint_DrawString_EN(0, 65, "Network:", &Font16, BACKGROUND_COLOR, WHITE);
    Paint_DrawString_EN(0, 90, "Storage:", &Font16, BACKGROUND_COLOR, WHITE);
};
